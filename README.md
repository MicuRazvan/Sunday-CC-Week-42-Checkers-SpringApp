...
For this week, we decided to build a checkers game using Spring. I'm allowed to work on it only Sunday.
...
## About the project
More information about the base game and rules: https://en.wikipedia.org/wiki/Checkers

#### How to run:
1.  Compile and run the Spring Boot application.
2.  Open your browser and navigate to `http://localhost:8080`.

<img width="911" height="726" alt="image" src="https://github.com/user-attachments/assets/01b8d685-0603-453b-a403-cba6a3d6ba56" />
